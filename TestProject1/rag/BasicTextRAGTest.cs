...
public class BasicTextRAGTest
{
    [Fact]
    public async Task TestRAGAsync()
    {
        DotNetEnv.Env.Load();
        ...
        AIAgent agent = chatClient
            ...
            {
                ChatOptions = new() { ModelId = model, Instructions = "You are a helpful support specialist for Contoso Outdoors. Answer questions using the provided context and cite the source document when available." },
